...
function checkWinner(x, y, z){
    ...
    y--;
    z--;
    if ((span[x].dataset.player === span[y].dataset.player) && (span[y].dataset.player === span[z].dataset.player) && (span[x].dataset.player === span[z].dataset.player) && (span[x].dataset.player === "x" || span[x].dataset.player === "o") && isGameOver == false) {
        span[x].parentNode.className += " activeBox ";
        span[y].parentNode.className += " activeBox ";
        span[z].parentNode.className += " activeBox ";
        gameOver(x);
    }
}
...
function gameOver(x) {
    var gameOverAlertElement = "<b> GAME OVER </b><br><br> Player " + span[x].dataset.player.toUpperCase() + ' Win !!! <br><br>' + restartButton;
